...
#include <stdio.h>    // FILE, fopen, fgets, sscanf, fclose, perror
...
// void graph_add_edge(graph_t *g, int u, int v, int weight, int directed);
// void graph_remove_edge(graph_t *g, int u, int v, int directed);
...
//     g->g[u].rowAdj[v] = weight;
//     if (!directed) {
//         g->g[v].rowAdj[u] = weight;
//     }
// }
